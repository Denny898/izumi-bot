...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~igopodimis",
  ...
  BOT_NAME: process.env.BOT_NAME || "DENBOY MD",
  ...
  AUTHOR: process.env.AUTHOR || "DENBOY",
  PRESENCE: process.env.PRESENCE || "typing", //available, typing, recording
